...
var app = new Vue({
  ...
  methods: {
    ...
    scoringCalcul: function () {
      return (
        this.userResponses[0] +
        this.userResponses[1] +
        this.userResponses[2] +
        this.userResponses[3]
      );
    },
    ...
    showScore: function () {
      ...
      if (scoring == 100) {
        ...
        const jeCode = (document.getElementById("Master").style.display =
          "block");

        intermediaire.style.display = "none";
      } else if (scoring >= 70 && scoring <= 90) {
        texte = "je code !";
        const avance = (document.getElementById("avance").style.display =
          "block");
        ...
        texte = "j'approfondis !";
        const intermediaire = (document.getElementById(
          "intermediaire"
        ).style.display = "block");
        ...
        const debutant = (document.getElementById("debutant").style.display =
          "block");
      }
